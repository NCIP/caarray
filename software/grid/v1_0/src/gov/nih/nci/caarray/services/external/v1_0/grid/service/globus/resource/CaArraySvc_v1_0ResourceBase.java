...
public abstract class CaArraySvc_v1_0ResourceBase extends ReflectionResource implements Resource
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((CaArraySvc_v1_0ResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaArraySvc_v1_0Constants.DOMAINMODEL);
