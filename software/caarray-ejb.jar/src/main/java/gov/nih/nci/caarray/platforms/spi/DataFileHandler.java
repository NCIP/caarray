...
/**
 * SPI interface for handling of array data files. This is the interface to implement in order to support 
 * handling data files for a new array platform.
 * 
 * @author dkokotov
 */
public interface DataFileHandler {
    ...
    /**
     * Return a list of potential LSIDs for the array design that this data file was produced from.
