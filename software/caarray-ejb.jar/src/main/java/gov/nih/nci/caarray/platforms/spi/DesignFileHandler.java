...
/**
 * SPI interface for handling of array design files. This is the interface to implement in order to support 
 * handling design files for a new array platform.
 * 
 * @author dkokotov
 */
public interface DesignFileHandler {
    ...
    /**
     * Populate the given ArrayDesign instance with an ArrayDesignDetails instance holding the design elements making
     * up the array design defined in the currently open file set.
     * 
     * @param arrayDesign the ArrayDesign instance to be populated
     * @throws PlatformFileReadException if there is an error processing the design file set.
     */
