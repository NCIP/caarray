/**
 * CaArrayGridServiceResourceProperties.java
 *
...
public class CaArrayGridServiceResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public CaArrayGridServiceResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this CaArrayGridServiceResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this CaArrayGridServiceResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CaArrayGridServiceResourceProperties)) return false;
        CaArrayGridServiceResourceProperties other = (CaArrayGridServiceResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CaArrayGridServiceResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://caarray.cagrid.nci.nih.gov/CaArrayGridService", ">CaArrayGridServiceResourceProperties"));
