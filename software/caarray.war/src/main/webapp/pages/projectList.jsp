...
<body>
    <div id="content" class="homepage">
        ...
        <display:table name="projects" class="table" requestURI="" id="projectList">
            <display:column property="experiment.title" title="Experiment Title" escapeXml="true" href="Project_edit.action" paramId="id" paramProperty="id" titleKey="project.id"/>
        </display:table>
    </div>
