...
<caarray:tabPane>
    <caarray:projectListTabItemForm entityName="ExperimentContact" item="${currentExperimentContact}"
	    ...
	    <s:textfield requiredLabel="true" key="currentExperimentContact.contact.firstName" size="80"
               tabindex="1" maxlength="254"/>
       	<s:textfield requiredLabel="true" key="currentExperimentContact.contact.lastName" size="80"
               tabindex="2" maxlength="254" />
        <s:textfield  requiredLabel="true" key="currentExperimentContact.contact.email" size="80"
