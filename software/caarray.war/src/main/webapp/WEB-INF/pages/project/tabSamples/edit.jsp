...
<caarray:tabPane subtab="true">
    <s:if test="currentSample.id == null">
    ...
    <div class="boxpad2">
        ...
        <s:form action="ajax/project/listTab/Samples/save" cssClass="form" id="projectForm" onsubmit="TabUtils.submitSubTabForm('projectForm', 'tabboxlevel2wrapper', 'save_draft'); return false;">
        ...
        <a href="#" onclick="TabUtils.submitSubTabForm('projectForm', 'tabboxlevel2wrapper', 'save_draft');" class="save" tabindex="3"><img src="<c:url value="/images/btn_save_draft.gif"/>" alt="Save Draft"></a>
   </div>
</caarray:tabPane>