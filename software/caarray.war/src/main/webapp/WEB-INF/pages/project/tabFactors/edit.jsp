...
<caarray:tabPane subtab="true">
    <s:if test="currentFactor.id == null">
    ...
    <div class="boxpad2">
        ...
        <s:form action="ajax/project/listTab/Factors/save" cssClass="form" id="projectForm" onsubmit="TabUtils.submitSubTabForm('projectForm', 'tabboxlevel2wrapper', 'save_draft'); return false;">
