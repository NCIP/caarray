...
<div id="infobar">
    <div id="rightinfo"> <span title="Subsersion URL: <c:out value='${initParam["svnUrl"]}'/>, revision: <c:out value='${initParam["svnRevision"]}'/>">caArray <c:out value='${initParam["caarrayVersion"]}'/></span> |  Node: <span>NCICB</span> | <a href="<c:url value="/protected/Logout.action"/>"><span>Logout</span></a></div>
</div>
