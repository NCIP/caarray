...
/**
 * Basic implementation of the GEO array design file handler - only the LSID is set.
 *
 * @author Doug Harley
 */
public class GeoUnsupportedDesignHandler extends AbstractArrayDesignHandler {
    ...
    private static final Logger LOG = Logger.getLogger(GeoUnsupportedDesignHandler.class);

    GeoUnsupportedDesignHandler(VocabularyService vocabularyService, CaArrayDaoFactory daoFactory,
