...
/**
 * Basic implementation of the Imagene TPL array design file handler - only the LSID is set.
 *
 * @author Steve Lustbader
 */
public class ImageneTplHandler extends AbstractArrayDesignHandler {
    ...
    private static final Logger LOG = Logger.getLogger(ImageneTplHandler.class);

    ImageneTplHandler(VocabularyService vocabularyService, CaArrayDaoFactory daoFactory, CaArrayFile designFile) {
