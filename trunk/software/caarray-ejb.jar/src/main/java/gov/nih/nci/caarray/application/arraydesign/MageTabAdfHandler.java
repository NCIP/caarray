...
/**
 * Basic implementation of the MAGETAB ADF array design file handler - only the LSID is set.
 *
 * @author Steve Lustbader
 */
public class MageTabAdfHandler extends AbstractArrayDesignHandler {
    ...
    private static final Logger LOG = Logger.getLogger(MageTabAdfHandler.class);

    MageTabAdfHandler(VocabularyService vocabularyService, CaArrayDaoFactory daoFactory, CaArrayFile designFile) {
