...
DROP SEQUENCE  IF EXISTS LOG_MESSAGE_ID_SEQ;

CREATE  SEQUENCE  LOG_MESSAGE_ID_SEQ;

CREATE TABLE LOG_MESSAGE
(
  LOG_ID bigint NOT NULL default nextval('LOG_MESSAGE_ID_SEQ'),
...
DROP SEQUENCE  IF EXISTS OBJECT_ATTRIBUTE_ID_SEQ;

CREATE  SEQUENCE  OBJECT_ATTRIBUTE_ID_SEQ;

CREATE TABLE OBJECT_ATTRIBUTE
(
  OBJECT_ATTRIBUTE_ID bigint NOT NULL default nextval('OBJECT_ATTRIBUTE_ID_SEQ'),
