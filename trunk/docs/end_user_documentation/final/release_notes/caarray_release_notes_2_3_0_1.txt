...
------------------------
    ...
    * caArray v2.3.1		-- January 2010 (new features)
...
Highlights of caArray 2.3.0 are:

* New API: richer, faster, and enables backwards compatibility

* Audit trail of permissions changes

* Separation of experiment locking from permissions control

* Ability to download array designs
...
Please note: new wiki based technical guide and the installation guide can be found at 
following locations:

caArray 2.3.0 Installation Guide: https://wiki.nci.nih.gov/x/VQcuAQ
caArray 2.3.0 Technical Guide: https://wiki.nci.nih.gov/x/eiIhAQ
caArray 2.3.0 API Guide: https://wiki.nci.nih.gov/x/EgBLAQ
