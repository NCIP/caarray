...
public class RplaTabImporter {
										...
										Experiment translatedExperiment)
	{
		...
		LOG.info("adding in mergeTranslatedData , number of rplasamples=" +originalExperiment.getRplaSamples()
																							.size());
		...
		LOG.info("antibody size =" + originalExperiment	.getAntibodies()
															.size());
		originalExperiment	.getRplaSamples()
							.addAll(translatedExperiment.getRplaSamples());

		LOG.info("rplasamples size =" + originalExperiment.getRplaSamples()
															.size());
