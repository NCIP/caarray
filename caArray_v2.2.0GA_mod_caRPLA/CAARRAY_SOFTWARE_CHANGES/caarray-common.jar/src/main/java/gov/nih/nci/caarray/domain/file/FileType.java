...
public enum FileType implements Comparable<FileType> {
	...
	/**
	 * Affymetrix native CLF array design format (paired with an
	 * {@link #AFFYMETRIX_PGF} file).
	 */
	AFFYMETRIX_CLF,
	...
	/**
	 * Affymetrix native PGF array design format (paired with an
	 * {@link #AFFYMETRIX_CLF} file).
	 */
	AFFYMETRIX_PGF,
	...
	RPLA_TAB_SRADF,
	/**
	 * The caRPLA scanned TIFF image
	 */
	RPLA_TAB_TIFF,

	/**
	 * The caRPLA derived array data (from the scanned image)
	 */
	RPLA_TAB_TXT,
	...
	static {
		...
		RAW_TO_DERIVED_MAP.put(RPLA_TAB_TIFF, RPLA_TAB_TXT);
		DERIVED_TO_RAW_MAP.put(RPLA_TAB_TXT, RPLA_TAB_TIFF);
