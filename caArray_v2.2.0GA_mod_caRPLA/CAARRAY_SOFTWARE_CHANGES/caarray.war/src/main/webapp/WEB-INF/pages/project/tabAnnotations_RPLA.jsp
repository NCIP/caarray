...
<ajax:tabPanel panelStyleId="tablevel2" panelStyleClass="tablevel2" currentStyleClass="selected" contentStyleId="tabboxlevel2wrapper" contentStyleClass="tabboxlevel2wrapper"
    ...
    <caarray:tab caption="RplaSamples" baseUrl="${samplesUrl}" defaultTab="${initTab == 'samples'}" />
    <caarray:tab caption="RplArrays" baseUrl="${hybridizationsUrl}" defaultTab="${initTab == 'hybridizations'}" />
    <caarray:tab caption="Antibodies" baseUrl="${hybridizationsUrl}" defaultTab="${initTab == 'hybridizations'}" />
    <caarray:tab caption="RplaHybridizations" baseUrl="${hybridizationsUrl}" defaultTab="${initTab == 'hybridizations'}" />
