    ...
    <ajax:displayTag id="datatable" ajaxFlag="true" tableClass="searchresults" preFunction="TabUtils.showLoadingTextKeepMainContent" postFunction="TabUtils.hideLoadingText">
        <display:table class="searchresults" cellspacing="0" list="${pagedItems}"
            ...
            <display:column titleKey="experiment.rplahybridizations.name" sortable="true" sortProperty="NAME">
                <caarray:projectListTabActionLink linkContent="${row.name}" entityName="RplaHybridization" action="view" itemId="${row.id}" isSubtab="false" maxWidth="30"/>
            </display:column>
             <display:column property="date" sortProperty="NAME" titleKey="experiment.rplahybridizations.date" sortable="true" maxLength="30"/>
            <display:column property="rplArray" sortProperty="NAME" titleKey="experiment.rplahybridizations.rplarray.name" sortable="true" maxLength="30"/>
