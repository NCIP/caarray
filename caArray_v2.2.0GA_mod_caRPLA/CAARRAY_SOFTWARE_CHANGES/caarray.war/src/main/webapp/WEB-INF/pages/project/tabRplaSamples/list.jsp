...
RplaSamples list here...

<caarray:tabPane subtab="true">
    <caarray:projectListTabHeader entityName="RplaSample" isSubtab="true"/>
    ...
    <ajax:displayTag id="datatable" ajaxFlag="true" tableClass="searchresults" preFunction="TabUtils.showLoadingTextKeepMainContent" postFunction="TabUtils.hideLoadingText">
        <display:table class="searchresults" cellspacing="0" list="${pagedItems}"
            ...
            <display:column titleKey="experiment.rplasamples.name" sortable="true" sortProperty="NAME">
               ...
               <display:column titleKey="experiment.rplasamples.rplarray.name">
